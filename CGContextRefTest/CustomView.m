...
- (void)drawRect:(CGRect)rect {
    ...
    /*写文字*/
    UIFont  *font = [UIFont boldSystemFontOfSize:15.0];//设置字体大小
#pragma mark - Pre__iOS_7_0_version
    {
...
#pragma mark - Cur__iOS_version
    NSDictionary *fontDic = @{NSFontAttributeName:font,
                              NSForegroundColorAttributeName:[UIColor redColor]};
    
    [@"画圆" drawInRect:CGRectMake(10, 20, 80, 20) withAttributes:fontDic];
    [@"画线及孤线：" drawInRect:CGRectMake(10, 80, 100, 20) withAttributes:fontDic];
    [@"画矩形：" drawInRect:CGRectMake(10, 120, 80, 20) withAttributes:fontDic];
    [@"画扇形和椭圆：" drawInRect:CGRectMake(10, 160, 110, 20) withAttributes:fontDic];
    [@"画三角形：" drawInRect:CGRectMake(10, 220, 80, 20) withAttributes:fontDic];
    [@"画圆角矩形：" drawInRect:CGRectMake(10, 260, 100, 20) withAttributes:fontDic];
    [@"画贝塞尔曲线：" drawInRect:CGRectMake(10, 300, 100, 20) withAttributes:fontDic];
    [@"图片：" drawInRect:CGRectMake(10, 340, 80, 20) withAttributes:fontDic];
    ...
    //填充圆，无边框
    CGContextAddArc(context, 150, 33, 30, 0, 2*M_PI, 0); //添加一个圆
    ...
    CGContextAddArc(context, 250, 43, 40, 0, 2*M_PI, 0); //添加一个圆
